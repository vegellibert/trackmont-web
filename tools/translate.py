...
resource = json.load(request("https://www.transifex.com/api/2/project/trackmont/resource/web/?details"))

for language in resource["available_languages"]:
    code = language["code"]
    data = request("https://www.transifex.com/api/2/project/trackmont/resource/web/translation/" + code + "?file")

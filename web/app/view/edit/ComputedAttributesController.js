...
Ext.define('Trackmont.view.edit.ComputedAttributesController', {
    extend: 'Trackmont.view.edit.ToolbarController',
    alias: 'controller.computedAttributes',

    requires: [
        'Trackmont.view.dialog.ComputedAttribute',
        'Trackmont.model.ComputedAttribute'
    ],

    objectModel: 'Trackmont.model.ComputedAttribute',
    objectDialog: 'Trackmont.view.dialog.ComputedAttribute',

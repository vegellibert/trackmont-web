...
Ext.define('Trackmont.view.edit.CalendarsController', {
    extend: 'Trackmont.view.edit.ToolbarController',
    alias: 'controller.calendars',

    requires: [
        'Trackmont.view.dialog.Calendar',
        'Trackmont.model.Calendar'
    ],

    objectModel: 'Trackmont.model.Calendar',
    objectDialog: 'Trackmont.view.dialog.Calendar',

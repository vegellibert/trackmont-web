...
Ext.define('Trackmont.view.edit.AttributesController', {
    extend: 'Trackmont.view.edit.ToolbarController',
    alias: 'controller.attributes',

    requires: [
        'Trackmont.view.dialog.Attribute',
        'Trackmont.store.Attributes',
    ...
    init: function () {
        ...
        store = Ext.create('Trackmont.store.Attributes');
        ...
        if (this.getView().record instanceof Trackmont.model.Device) {
            this.getView().attributesStore = 'DeviceAttributes';
        } else if (this.getView().record instanceof Trackmont.model.Geofence) {
            this.getView().attributesStore = 'GeofenceAttributes';
        } else if (this.getView().record instanceof Trackmont.model.Group) {
            this.getView().attributesStore = 'GroupAttributes';
        } else if (this.getView().record instanceof Trackmont.model.Server) {
            this.getView().attributesStore = 'ServerAttributes';
        } else if (this.getView().record instanceof Trackmont.model.User) {
    ...
    initDialog: function (record) {
        var nameTextField, dialog = Ext.create('Trackmont.view.dialog.Attribute');
    ...
    onAddClick: function () {
        var objectInstance = Ext.create('Trackmont.model.Attribute');

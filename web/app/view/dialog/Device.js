...
Ext.define('Trackmont.view.dialog.Device', {
            ...
            items: [{
                ...
                listConfig: {
                    getInnerTpl: function () {
                        ...
                        '{[new XMLSerializer().serializeToString(Trackmont.DeviceImages.getImageSvg(' +
                        'Trackmont.Style.mapColorOnline, false, 0, values.key))]}</div></td>' +
                        '<td>{name}</td></tr></table>';
                    }
                }
            }]

...
Ext.define('Trackmont.view.map.BaseMap', {
    ...
    initMap: function () {
        ...
        server = Trackmont.app.getServer();

        type = Trackmont.app.getPreference('map', null);
        ...
        lat = Trackmont.app.getPreference('latitude', Trackmont.Style.mapDefaultLat);
        lon = Trackmont.app.getPreference('longitude', Trackmont.Style.mapDefaultLon);
        zoom = Trackmont.app.getPreference('zoom', Trackmont.Style.mapDefaultZoom);

        this.mapView = new ol.View({
            center: ol.proj.fromLonLat([lon, lat]),
            zoom: zoom,
            maxZoom: Trackmont.Style.mapMaxZoom
        });

...
Ext.define('Trackmont.model.Event', {
        ...
        convert: function (v, rec) {
            ...
            if (rec.get('type') === 'commandResult') {
                ...
                text = Strings.eventDriverChanged + ': ' +
                    Trackmont.AttributeFormatter.driverUniqueIdFormatter(rec.get('attributes')['driverUniqueId']);
            } else {
                text = Trackmont.app.getEventString(rec.get('type'));
            }

...
Ext.define('Trackmont.Application', {
    ...
    getReportColor: function (deviceId) {
        ...
        if (reportColor) {
            ...
            if (deviceId !== undefined) {
                index = deviceId % Trackmont.Style.mapRouteColor.length;
            }
            return Trackmont.Style.mapRouteColor[index];
        }
    },
    ...
    showToast: function (message, title) {
        Ext.toast({
            html: message,
            title: title,
            width: Trackmont.Style.toastWidth,
            align: 'br'
        });
    }
});
